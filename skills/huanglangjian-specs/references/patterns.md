...
> `id` requirements, `union` mapping rules live in [model-kinds.md](./model-kinds.md); tag behavior lives in [api-reference.md](./api-reference.md); field text/title/description rules live in [writing-guide.md](./writing-guide.md).
